...
import de.fourtytwoways.enums.core.EnumProvider;
...
public class ExampleProvider implements EnumProvider {
    @Override
    ...
    private List<EnumEntry> getTariffs() {
        ...
        tariffs.add(new Tariff(2, "BU210", "Berrufsunfähigkeit Zusatzversicherung"));
