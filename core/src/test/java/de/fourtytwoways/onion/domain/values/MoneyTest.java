...
class MoneyTest {
    ...
    void valueOf() {
        ...
        assertEquals(Money.valueOf(new BigDecimal(1.), Money.Currency.EUR), m1);
        ...
        assertNotEquals(Money.valueOf(new BigDecimal(1.), Money.Currency.EUR), m2);
    ...
    void getAmount() {
        Money m1 = Money.valueOf(1.2);
        assertEquals(BigDecimal.valueOf(1.2).setScale(2), m1.getAmount());
    }
